...
export function Newsletter() {
  ...
  return (
    <section id="newsletter" className="relative overflow-hidden py-24">
      <div
        aria-hidden
        className="pointer-events-none absolute right-[-3rem] top-16 h-64 w-64 rounded-full bg-gradient-to-br from-gold/20 via-ivory/40 to-transparent blur-3xl"
      />
      <div className="container">
        <Reveal className="rounded-panel border border-gold/20 bg-white/95 p-10 shadow-soft">
